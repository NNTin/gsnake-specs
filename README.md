...
Some documentation files reference sibling repositories (e.g., `../gsnake-core`)
in the context of:
...
These are **documentation references** (describing how other parts of the system
work), not **build dependencies** (required to build this repository).
...
- [Repository Architecture](tasks/repo-architecture.md) - Central documentation
  for dependency management
- [Standalone Submodules Build PRD](tasks/prd-standalone-submodules-build.md) -
  PRD for standalone build strategy
- [CI/CD Workflows PRD](tasks/prd-ci-tests-and-workflows.md) - CI/CD strategy
  documentation
...
1. Use absolute GitHub URLs for external references
...
You can test the CI workflow locally using
...
- Link checking may behave differently locally vs GitHub Actions
  (network/cache differences)
- Some GitHub Actions features may not work identically in local Docker
  environment
